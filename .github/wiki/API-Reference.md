...
| Production (web SaaS) | Configured via `VITE_HASURA_URL` / `EXPO_PUBLIC_HASURA_URL` |
...
See `apps/mobile/src/lib/graphql/` or `apps/web/src/lib/graphql/` for current operation definitions.
