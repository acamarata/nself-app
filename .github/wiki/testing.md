...
ɳTasks uses a three-layer test pyramid: unit, integration, and e2e. The React Native mobile app (`apps/mobile/`, this repo) uses jest-expo; the web SaaS (`web/`) uses Vitest.
...
| `web/` | `cd web && pnpm test` | Vitest unit tests |
